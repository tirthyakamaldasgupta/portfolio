...
export default function Footer() {
    return (<>
        <Heading size={"xs"} color={"#000000"} textAlign={"center"} marginBottom={2}>Copyright © 2023 Tirthya Kamal
            Dasgupta. All rights reserved.</Heading>
        <HStack justifyContent={"center"}>
            <Heading size={"xs"} color={"#000000"} fontWeight={"normal"}>Powered by</Heading>
            <Link href="https://nextjs.org/" target={"_blank"} rel="noreferrer" isExternal><NextJSIcon/></Link>
            <Heading size={"xs"} color={"#000000"} fontWeight={"normal"}>and</Heading>
            <Link href="https://chakra-ui.com/" target={"_blank"} rel="noreferrer" isExternal><ChakraUIIcon/></Link>
            <Heading size={"xs"} color={"#000000"} fontWeight={"normal"}>and deployed to</Heading>
